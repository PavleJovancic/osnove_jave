...
public class ValueSubstitution_LocustCommands {
    public static void main(String[] args) {
        ...
        while (locustCommand.contains("$")){
            System.out.println("Command: " + locustCommand);
            System.out.print("Enter variable name to replace: ");
            String variableName = s.next();
            System.out.print("Enter new value: ");
            String replacementValue = s.next();
            locustCommand = locustCommand.replace(variableName, replacementValue);
        }
        System.out.println("Command: " + locustCommand);
    }
}
