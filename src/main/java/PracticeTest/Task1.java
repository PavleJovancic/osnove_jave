...
//
        ...
        System.out.print("Enter Installed Version Major Number: ");
        int installedVersionMajorNumber = s.nextInt();
        System.out.print("Enter Installed Version Minor Number: ");
        int installedVersionMinorNumber = s.nextInt();
        System.out.print("Enter New Version Major Number: ");
        int newVersionMajorNumber = s.nextInt();
        System.out.print("Enter New Version Minor Number: ");
        int newVersionMinorNumber = s.nextInt();

        if (installedVersionMajorNumber == newVersionMajorNumber && installedVersionMinorNumber == newVersionMinorNumber){
            System.out.println("Application is up to date.");
        } else {
            System.out.println("New version is ready to install.");
        }
